...
//If the param value is 'green' set colorResponse variable tso 'Green is okay'. If the param value is 'red' set reponse variable to 'I heart red'. Otherwise set the colorResponse variable to 
//'What is your favorite color?'. Make sure to return the colorResponse variable at the end once it has been properly set.
...
function greeter(name,number){
  var introduction = "Hi! I am " + name + " and I am " + number + " years old";
  return introduction;
}
